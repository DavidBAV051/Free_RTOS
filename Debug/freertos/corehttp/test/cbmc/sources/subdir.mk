...
freertos/corehttp/test/cbmc/sources/%.o: ../freertos/corehttp/test/cbmc/sources/%.c freertos/corehttp/test/cbmc/sources/subdir.mk
	@echo 'Building file: $<'
...
clean-freertos-2f-corehttp-2f-test-2f-cbmc-2f-sources:
	-$(RM) ./freertos/corehttp/test/cbmc/sources/http_cbmc_state.d ./freertos/corehttp/test/cbmc/sources/http_cbmc_state.o
