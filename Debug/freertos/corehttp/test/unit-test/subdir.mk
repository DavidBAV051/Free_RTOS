...
freertos/corehttp/test/unit-test/%.o: ../freertos/corehttp/test/unit-test/%.c freertos/corehttp/test/unit-test/subdir.mk
	@echo 'Building file: $<'
...
clean-freertos-2f-corehttp-2f-test-2f-unit-2d-test:
	-$(RM) ./freertos/corehttp/test/unit-test/core_http_send_utest.d ./freertos/corehttp/test/unit-test/core_http_send_utest.o ./freertos/corehttp/test/unit-test/core_http_utest.d ./freertos/corehttp/test/unit-test/core_http_utest.o
